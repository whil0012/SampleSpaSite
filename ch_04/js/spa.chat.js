...
spa.chat = (function () {
    ...
    setPxSizes = function () {
        ...
        // Could this get the height of the spa-chat-head element in em,
        // instead of hard-coding the subtracted value here?
        jqueryMap.$sizer.css({
    ...
    //                            methods to manage the list of people the
    //                            model maintains.
    //      * slider_*          - All these are optional scalars. See
    //                            mapConfig.settable_map for a full list.
    //                            Example: slider_open_em is the open height
    //                            in em's.
    // Settings     :
    ...
    // Actions      :
    //      If the window height of width falls below
